...
//	go detail(*t.Channel)
//
//	proc.OnvifMessage = "not running, wait getStreamType decoder"
//	proc.TNGVideoToolMessage = proc.OnvifMessage
//	var err error
//	for {
//		if proc.Decoder, err = getStreamType(t.RTSPAddr); err == nil {
//			break
//		}
//		proc.logger.Printf("getStreamType err: %+v", err)
//		time.Sleep(time.Second * 3)
//	}
//
//	go proc.startOnvif()
...
//			return
//		case <-tick.C:
//			p.logger.Printf("[onvif]%s", p.OnvifMessage)
//			if p.OnvifPidName != "" {
